...
contract FtsoInflationConfigurationsTest is Test {
    ...
    function testAddConfigRevertInvalidFeedIdsLength() public {
        ...
        vm.expectRevert("invalid feedIds length");
        inflationConfigs.addFtsoConfiguration(config);
    }
    ...
    function testAddFtsoConfiguration() public {
        ...
        feeds = bytes.concat(bytes21("feed3"), bytes21("feed4"));
        config = IFtsoInflationConfigurations.FtsoConfiguration(
            feeds,
            10,
            6000,
        ...
        assertEq(ftsoConfigurations[1].feedIds, feeds);
