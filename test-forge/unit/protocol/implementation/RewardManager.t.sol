...
contract RewardManagerTest is Test {
    ...
    function testClaimDirect() public {
        ...
        RewardsV2Interface.RewardClaim memory body = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(voter1), 100, RewardsV2Interface.ClaimType.DIRECT);
        RewardsV2Interface.RewardClaimWithProof memory proof = RewardsV2Interface.RewardClaimWithProof(
            merkleProof, body);
        proofs[0] = proof;
        ...
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, voter1, voter1, rewardEpochData.id, body.claimType, body.amount);
        rewardManager.claim(voter1, payable(voter1), rewardEpochData.id, false, proofs);
    ...
    function testClaimDirectAddressZero() public {
        ...
        RewardsV2Interface.RewardClaimWithProof[] memory proof1 = new RewardsV2Interface.RewardClaimWithProof[](1);
        RewardsV2Interface.RewardClaimWithProof[] memory proof2 = new RewardsV2Interface.RewardClaimWithProof[](1);

        RewardsV2Interface.RewardClaim memory body1 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(voter1), 100, RewardsV2Interface.ClaimType.DIRECT);
        RewardsV2Interface.RewardClaim memory body2 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(address(0)), 200, RewardsV2Interface.ClaimType.DIRECT);
        ...
        proof1[0] = RewardsV2Interface.RewardClaimWithProof(merkleProof1, body1);
        merkleProof2[0] = leaf1;
        proof2[0] = RewardsV2Interface.RewardClaimWithProof(merkleProof2, body2);
    ...
    function testClaimDirectAndWeightBased1() public {
        ...
        RewardEpochData memory rewardEpochData = RewardEpochData(0, 10);
        RewardsV2Interface.RewardClaimWithProof[] memory proofs = new RewardsV2Interface.RewardClaimWithProof[](2);
        merkleProof1 = new bytes32[](1);
        merkleProof2 = new bytes32[](1);
        ...
        merkleProof2[0] = leaf1;
        proofs[1] = RewardsV2Interface.RewardClaimWithProof(merkleProof2, body2);
        ...
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, voter1, voter1, rewardEpochData.id, body2.claimType, 166);
        rewardManager.claim(voter1, payable(voter1), rewardEpochData.id, false, proofs);
    ...
    function testClaimDirectAndWeightBase2() public {
        ...
        proofs = new RewardsV2Interface.RewardClaimWithProof[](2);
        merkleProof1 = new bytes32[](1);
        merkleProof2 = new bytes32[](1);
    ...
    function testClaimWeightBased3() public {
        ...
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, delegator, delegator, 0, RewardsV2Interface.ClaimType.WNAT, 10);
    ...
    function testClaimDirectAndWeightBased2() public {
        ...
        RewardEpochData memory rewardEpochData = RewardEpochData(0, 10);
        RewardsV2Interface.RewardClaimWithProof[] memory proofs = new RewardsV2Interface.RewardClaimWithProof[](4);
        ...
        RewardsV2Interface.RewardClaim memory body2 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(voter1), 200, RewardsV2Interface.ClaimType.WNAT);
        RewardsV2Interface.RewardClaim memory body3 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, nodeId1, 300, RewardsV2Interface.ClaimType.MIRROR);
        RewardsV2Interface.RewardClaim memory body4 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(account1), 400, RewardsV2Interface.ClaimType.CCHAIN);
        ...
        proofs[2] = RewardsV2Interface.RewardClaimWithProof(merkleProof3, body3);

        // proof for CCHAIN claim
        merkleProof4[0] = hashes[2];
        merkleProof4[1] = hashes[4];
        proofs[3] = RewardsV2Interface.RewardClaimWithProof(merkleProof4, body4);
        ...
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(address(nodeId1), voter1, voter1, rewardEpochData.id, body3.claimType, 262);
        // CCHAIN rewards; should receive floor (400 * 450 / 500) = 360
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(account1, voter1, voter1, rewardEpochData.id, body4.claimType, 360);
        rewardManager.claim(voter1, payable(voter1), rewardEpochData.id, false, proofs);
        // uint256 balanceAfter = voter1.balance;
    ...
    function testClaimDirectAndWeightBased3() public {
       ...
       _enableCChainStake();
        ...
        proofs = new RewardsV2Interface.RewardClaimWithProof[](4);
        merkleProof1 = new bytes32[](2);
        merkleProof2 = new bytes32[](2);
        merkleProof3 = new bytes32[](2);
        merkleProof4 = new bytes32[](2);
        ...
        body1 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(voter1), 100, RewardsV2Interface.ClaimType.DIRECT);
        body2 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(voter1), 200, RewardsV2Interface.ClaimType.WNAT);
        body3 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, nodeId1, 300, RewardsV2Interface.ClaimType.MIRROR);
        body4 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(account1), 400, RewardsV2Interface.ClaimType.CCHAIN);
        ...
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(address(nodeId1), voter1, voter1, rewardEpochData.id, body3.claimType, 175);
        // CCHAIN rewards; all 500 were already used for initializations. nothing left for cChain claim
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(account1, voter1, voter1, rewardEpochData.id, body4.claimType, 0);
        rewardManager.claim(voter1, payable(voter1), rewardEpochData.id, false, proofs);
    ...
    function testGetStateOfRewards() public {
        ...
        merkleProof1[0] = hashes[1];
        merkleProof1[1] = hashes[5];
        directProofs[0] = RewardsV2Interface.RewardClaimWithProof(merkleProof1, body1);

        // proof for WNAT claim
        merkleProof2[0] = hashes[0];
        merkleProof2[1] = hashes[5];
        proofs[0] = RewardsV2Interface.RewardClaimWithProof(merkleProof2, body2);

        // proof for MIRROR claim
        merkleProof3[0] = hashes[3];
        merkleProof3[1] = hashes[4];
        proofs[1] = RewardsV2Interface.RewardClaimWithProof(merkleProof3, body3);

        // proof for CCHAIN claim
        merkleProof4[0] = hashes[2];
        merkleProof4[1] = hashes[4];
        proofs[2] = RewardsV2Interface.RewardClaimWithProof(merkleProof4, body4);
        ...
        proofs = new RewardsV2Interface.RewardClaimWithProof[](3);
        merkleProof1 = new bytes32[](2);
        merkleProof2 = new bytes32[](2);
        merkleProof3 = new bytes32[](2);
        merkleProof4 = new bytes32[](2);
        ...
        body1 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(voter1), 50, RewardsV2Interface.ClaimType.FEE);
        body2 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(voter1), 100, RewardsV2Interface.ClaimType.WNAT);
        body3 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, nodeId1, 150, RewardsV2Interface.ClaimType.MIRROR);
        body4 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(account1), 200, RewardsV2Interface.ClaimType.CCHAIN);
        hashes = new bytes32[](7);
        hashes[0] = keccak256(abi.encode(body1)); // leaf1
        hashes[1] = keccak256(abi.encode(body2)); // leaf2
        hashes[2] = keccak256(abi.encode(body3)); // leaf3
        ...
        merkleProof1[0] = hashes[1];
        merkleProof1[1] = hashes[5];
        directProofs[1] = RewardsV2Interface.RewardClaimWithProof(merkleProof1, body1);
        ...
        proofs = new RewardsV2Interface.RewardClaimWithProof[](0);
        ...
        // MIRROR rewards; should receive floor(300 * 350 / 400) = 262
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(address(nodeId1), voter1, voter1, 0, body3.claimType, 262);
        // CCHAIN rewards; should receive floor (400 * 450 / 500) = 360
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(account1, voter1, voter1, 0, body4.claimType, 360);
        ...
        uint256 balanceBefore = voter1.balance;
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, voter1, voter1, 1, body2.claimType, 83);
        // MIRROR rewards; should receive floor(150 * 350 / 400) = 131
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(address(nodeId1), voter1, voter1, 1, body3.claimType, 131);
        // CCHAIN rewards; should receive floor (200 * 450 / 500) = 180
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(account1, voter1, voter1, 1, body4.claimType, 180);
        ...
        // DIRECT reward
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, voter1, voter1, 0, RewardsV2Interface.ClaimType.DIRECT, 100);
        // FEE reward
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, voter1, voter1, 1, RewardsV2Interface.ClaimType.FEE, 50);
    ...
    function testInitializeWeightBasedAndAfterClaim() public {
        ...
        RewardManager.UnclaimedRewardState memory state =
            rewardManager.getUnclaimedRewardState(voter1, rewardEpochData.id, RewardsV2Interface.ClaimType.WNAT);
        ...
        rewardManager.initialiseWeightBasedClaims(proofs);
        state = rewardManager.getUnclaimedRewardState(voter1, rewardEpochData.id, RewardsV2Interface.ClaimType.WNAT);
        ...
        // WNAT rewards; should receive floor(200 * 250 / 300) = 166
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, voter1, voter1, rewardEpochData.id, body1.claimType, 166);
        rewardManager.claim(voter1, payable(voter1), rewardEpochData.id, false, proofs);
    ...
    function testClaimWeightBased2() public {
        ...
        emit IRewardManager.RewardClaimed(voter1, delegator2, delegator2, 0, RewardsV2Interface.ClaimType.WNAT, 17);
        rewardManager.claim(delegator2, payable(delegator2), 0, false, proofs);
    ...
    function testClaimReduceRewardAmount() public {
        ...
        emit IRewardManager.RewardClaimed(voter1, voter1, voter1, rewardEpochData.id, body.claimType, 50);
        rewardManager.claim(voter1, payable(voter1), rewardEpochData.id, false, proofs);
    ...
    function testClaimAndBurn() public {
        ...
        RewardsV2Interface.RewardClaimWithProof[] memory proofs = new RewardsV2Interface.RewardClaimWithProof[](1);
        RewardsV2Interface.RewardClaim memory body = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(voter1), 100, RewardsV2Interface.ClaimType.FEE);
        RewardsV2Interface.RewardClaimWithProof memory proof = RewardsV2Interface.RewardClaimWithProof(
            merkleProof, body);
        proofs[0] = proof;
        bytes32 leaf1 = keccak256(abi.encode(body));
        ...
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, voter1, BURN_ADDRESS, rewardEpochData.id, body.claimType, 10);
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, voter1, voter1, rewardEpochData.id, body.claimType, 90);
        rewardManager.claim(voter1, payable(voter1), rewardEpochData.id, false, proofs);
    ...
    function testClaimWeightRevertEpochExpired() public {
        ...
        // epoch 13 is expired
        RewardsV2Interface.RewardClaim memory body = RewardsV2Interface.RewardClaim(
            13, bytes20(voter1), 100, RewardsV2Interface.ClaimType.DIRECT);
        RewardsV2Interface.RewardClaimWithProof memory proof = RewardsV2Interface.RewardClaimWithProof(
            merkleProof, body);
        proofs[0] = proof;
        bytes32 leaf1 = keccak256(abi.encode(body));
    ...
    function testClaimWNatTwoDelegations() public {
        ...
        RewardsV2Interface.RewardClaim memory body1 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(voter1), 100, RewardsV2Interface.ClaimType.WNAT);
        RewardsV2Interface.RewardClaim memory body2 = RewardsV2Interface.RewardClaim(
            rewardEpochData.id, bytes20(voter2), 200, RewardsV2Interface.ClaimType.WNAT);
        bytes32 leaf1 = keccak256(abi.encode(body1));
        bytes32 leaf2 = keccak256(abi.encode(body2));
        bytes32 merkleRoot = _hashPair(leaf1, leaf2);
        ...
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, delegator, recipient, rewardEpochData.id, body1.claimType, 58);
        // second WNAT claim reward; should receive floor(250 * 0.3 / 400 * 200) = 37
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter2, delegator, recipient, rewardEpochData.id, body2.claimType, 37);
    ...
    function testAutoClaimPDA() public {
        ...
        // cchain: floor(400 * 10 / 500) = 8
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, rewardOwners[0], pdas[0], rewardEpochData.id, body2.claimType, 6);
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(address(nodeId1), rewardOwners[0],
            pdas[0], rewardEpochData.id, body3.claimType, 7);
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(account1, rewardOwners[0], pdas[0], rewardEpochData.id, body4.claimType, 8);
        // PDA WNat for owner1: floor(200 * 5 / 300) = 3
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, pdas[0], pdas[0], rewardEpochData.id, body2.claimType, 3);
        ...
        // cchain: floor(400 * 20 / 500) = 16
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, rewardOwners[1], pdas[1], rewardEpochData.id, body2.claimType, 13);
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(address(nodeId1), rewardOwners[1],
            pdas[1], rewardEpochData.id, body3.claimType, 15);
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(account1, rewardOwners[1], pdas[1], rewardEpochData.id, body4.claimType, 16);
        // PDA WNat for owner2: floor(200 * 15 / 300) = 10
        vm.expectEmit();
        emit IRewardManager.RewardClaimed(voter1, pdas[1], pdas[1], rewardEpochData.id, body2.claimType, 10);
    ...
    function testGetBalanceAndSupply() public {
        ...
        assertEq(locked, 1000 + 800);
        assertEq(inflation, 0);
        assertEq(totalClaimed, 90 + 10);
        (uint256 received, uint256 inflationRec, uint256 claimed, uint256 burned) = rewardManager.getTotals();
        assertEq(received, 1000 + 800);
        assertEq(inflationRec, 800);
        assertEq(claimed, 90);
        assertEq(burned, 10);

        (uint256 total0, uint256 totalInflation0, uint256 initialised0, uint256 claimed0, uint256 burned0) =
            rewardManager.getRewardEpochTotals(0);
        assertEq(total0, 1000);
        assertEq(totalInflation0, 0);
        assertEq(initialised0, 100);
        assertEq(claimed0, 90);
        assertEq(burned0, 10);

        (uint256 total1, uint256 totalInflation1, uint256 initialised1, uint256 claimed1, uint256 burned1) =
            rewardManager.getRewardEpochTotals(1);
        assertEq(total1, 800);
        assertEq(totalInflation1, 800);
        assertEq(initialised1, 0);
        assertEq(claimed1, 0);
        assertEq(burned1, 0);
    ...
    function testCloseExpiredRewardEpoch() public {
        ...
        vm.expectEmit();
        emit IRewardManager.RewardClaimsExpired(90);
        ...
        vm.expectEmit();
        emit IRewardManager.RewardClaimsExpired(91);
        rewardManager.closeExpiredRewardEpoch(91);
        assertEq(BURN_ADDRESS.balance, 1000);
        ...
        vm.prank(address(newRewardManager));
        vm.expectEmit();
        emit IRewardManager.RewardClaimsExpired(92);
        vm.expectEmit();
        emit IRewardManager.RewardClaimsExpired(92);
