...
contract TeeWalletProjectManagerFacetTest is Test {
    ...
    function testCreateProjectRevertSigningAlgoNotSupported() public {
        ...
        vm.prank(projectOwner1);
        vm.expectRevert(ITeeWalletProjectManagerFacet.SigningAlgoNotSupported.selector);
    ...
    function testSetBackupManager() public {
        ...
        vm.prank(projectOwner1);
        vm.expectEmit();
        emit ITeeWalletProjectManagerFacet.BackupManagerSet(projectId, backupManager);
    ...
    function testProposeNewOwner() public {
        ...
        vm.prank(projectOwner1);
        vm.expectEmit();
        emit ITeeWalletProjectManagerFacet.NewOwnerProposed(projectId1, newOwner);
    ...
    function testConfirmOwnership() public {
        ...
        vm.prank(newOwner);
        vm.expectEmit();
        emit ITeeWalletProjectManagerFacet.OwnershipConfirmed(projectId1, newOwner);
