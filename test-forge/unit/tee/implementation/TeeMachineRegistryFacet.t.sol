...
contract TeeMachineRegistryFacetTest is Test {
    ...
    ITeeMachineRegistryFacet.TeeMachineData private teeMachineData;
    ...
    ITeeMachineRegistryFacet.TeeMachineData private newTeeMachineData;
    ...
    function setUp() public {
        ...
        teeMachineData = ITeeMachineRegistryFacet.TeeMachineData({
        ...
        newTeeMachineData = ITeeMachineRegistryFacet.TeeMachineData({
            extensionId: extensionId,
    ...
    function testRegisterRevertInvalidTeePublicKeyOrSignature() public {
        ...
        vm.prank(owner);
        vm.expectRevert(ITeeMachineRegistryFacet.InvalidTeePublicKeyOrSignature.selector);
        flareTeeManager.register(teeMachineData, teeMachineDataSignature, teeProxyId, url, address(0));
    }
    ...
    function testRegisterRevertAlreadyRegistered() public {
        vm.startPrank(owner);
        flareTeeManager.register(teeMachineData, teeMachineDataSignature, teeProxyId, url, address(0));
        vm.expectRevert(ITeeMachineRegistryFacet.AlreadyRegistered.selector);
        flareTeeManager.register(teeMachineData, teeMachineDataSignature, teeProxyId, url, address(0));
        vm.stopPrank();
    }
    ...
    function testPauseRevertOnlyOwnerOrExpiredAvailabilityCheckOrDisabledVersion() public {
        testToProduction();
        vm.expectRevert(ITeeMachineRegistryFacet.OnlyOwnerOrExpiredAvailabilityCheckOrDisabledVersion.selector);
    ...
    function testPauseWithProofRevertInvalidResponseDataOrAvailabilityCheckStatus() public {
        ...
        vm.expectRevert(ITeeMachineRegistryFacet.InvalidResponseDataOrAvailabilityCheckStatus.selector);
        flareTeeManager.pauseWithProof(proof);
    }
    ...
    function testBan() public {
        ...
        vm.prank(extensionOwner);
        vm.expectEmit();
        emit ITeeMachineRegistryFacet.TeeMachineStatusChanged(teeId, ITeeMachineRegistryFacet.TeeStatus.BANNED);
        flareTeeManager.ban(teeId);
    }
    ...
    function testUpdateTeeMachineSettings() public {
        ...
        vm.prank(owner);
        vm.expectEmit();
        emit ITeeMachineRegistryFacet.TeeMachineSettingsUpdated(teeId, newTeeProxyIdLocal, newUrl);
        vm.recordLogs();
    ...
    function testGetTeeMachineWithAttestationData() public {
        testRegister();
        ITeeMachineRegistryFacet.TeeMachineWithAttestationData memory teeMachineAttData =
            flareTeeManager.getTeeMachineWithAttestationData(teeId);
    ...
    function _changeStateToProductionForTee(
        ...
        vm.prank(owner);
        vm.expectEmit();
        emit ITeeMachineRegistryFacet.TeeMachineStatusChanged(_teeId, ITeeMachineRegistryFacet.TeeStatus.PRODUCTION);
        flareTeeManager.toProduction(proof);
    }
