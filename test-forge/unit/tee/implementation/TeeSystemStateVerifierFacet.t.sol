...
contract TeeSystemStateVerifierFacetTest is Test {
    ...
    ITeeSystemStateVerifierFacet.TeeSystemState private teeSystemState;
    ...
    function setUp() public {
        ...
        teeSystemState.status = ITeeSystemStateVerifierFacet.TeeMachineStatus.ACTIVE;
    ...
    function testVerifyTeeSystemStateReturnStateVersion() public {
        ...
        ITeeMachineRegistryFacet.TeeMachineData memory data2 = ITeeMachineRegistryFacet.TeeMachineData({
            extensionId: extId2,
            publicKey: pub2,
            initialOwner: teeMachineOwner,
