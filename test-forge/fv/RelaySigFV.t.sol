...
// Symbolic proofs of relay() signature/threshold accounting.
//
...
contract RelaySigFV is RelayTestBase {
    ...
    // Bounded threshold soundness (2 signers). Two voters carry 200 <= threshold 260, so NO pair
    ...
    // Bounded no-repeat-index check (3 slots, indices [0,1,1]). The repeated index is rejected
