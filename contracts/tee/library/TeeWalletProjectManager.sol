 ...
 */
library TeeWalletProjectManager {
    ...
    /// @custom:storage-location erc7201:tee.TeeWalletProjectManager.State
    struct State {
    ...
    bytes32 internal constant STATE_POSITION = keccak256(
        abi.encode(uint256(keccak256("tee.TeeWalletProjectManager.State")) - 1)
