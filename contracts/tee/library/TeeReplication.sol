...
/**
 * @title TeeReplication
 * @notice Library for TEE machine replication management.
 * @dev Uses ERC-7201 namespaced storage.
 */
library TeeReplication {

    /// @custom:storage-location erc7201:tee.TeeReplication.State
    struct State {
    ...
    bytes32 internal constant STATE_POSITION = keccak256(
        abi.encode(uint256(keccak256("tee.TeeReplication.State")) - 1)
        ...
        internal
    {
        ...
        emit ITeeReplicationFacet.PauseBeforeUpgradeMinDurationSecondsSet(_duration);
    }
