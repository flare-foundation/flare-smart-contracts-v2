...
/**
 * @title ITeeWalletBackupManagerFacet
 * @notice Public interface for the TeeWalletBackupManagerFacet.
 */
interface ITeeWalletBackupManagerFacet is ITeeCommonErrors {
