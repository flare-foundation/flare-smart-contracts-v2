...
/**
 * @title ITeeWalletProjectManagerFacet
 * @notice Public interface for the TeeWalletProjectManagerFacet.
 */
interface ITeeWalletProjectManagerFacet is ITeeCommonErrors {
