...
/**
 * @title ITeeVersionManagerFacet
 * @notice Public interface for the TeeVersionManagerFacet.
 */
interface ITeeVersionManagerFacet {
    ...
    /**
     * Signs the TEE upgrade. Signer must be part of the source and/or target TEE governance.
     * Emits TeeUpgradeSourceSignatureAdded and/or TeeUpgradeTargetSignatureAdded event.
