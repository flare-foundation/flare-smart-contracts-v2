...
library GSSGovernance {
    bytes32 internal constant OWNER_CONFIG_TYPEHASH = keccak256(
        "FlareRelayOwnerConfiguration(uint256 sourceChainId,address safe,uint256 threshold,address[] owners)"
    );
    ...
    function ownerConfigHash(
        ...
        return keccak256(abi.encode(OWNER_CONFIG_TYPEHASH, sourceChainId, safe, threshold, owners));
    }
}
