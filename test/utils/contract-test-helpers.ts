...
import { findRequiredEvent, toBN } from "./test-helpers";
...
export async function executeTimelockedGovernanceCall<T extends Truffle.AnyEvent>(
  contract: Truffle.ContractInstance,
  methodCall: (governance: string) => Promise<Truffle.TransactionResponse<T>>
) {
