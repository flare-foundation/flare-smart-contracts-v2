...
Reads are **payable** because `FastUpdater.fetchCurrentFeeds` charges per-feed fees (calculated by [`FeeCalculator`](../../../contracts/userInterfaces/IFeeCalculator.sol)) unless the caller is on the `freeFetchAddresses` allowlist.
