...
| [`ExtensionGovernanceFacet`](../../../contracts/tee/facets/ExtensionGovernanceFacet.sol) | `ExtensionGovernance` | Per-extension governance: configure signers, threshold, sign extension upgrades. |
...
| [`GovernedFacet`](../../../contracts/tee/facets/GovernedFacet.sol) | (`FlareGovernance`) | Diamond-internal `onlyGovernance` modifier and `Governed` accessors. |
