...
| [`ITeePayments`](../../contracts/userInterfaces/tee/ITeePayments.sol), [`ITeePaymentsFeeScheduleManager`](../../contracts/userInterfaces/tee/ITeePaymentsFeeScheduleManager.sol), [`ITeePaymentsLimitsManager`](../../contracts/userInterfaces/tee/ITeePaymentsLimitsManager.sol), [`ITeePaymentsRegistry`](../../contracts/userInterfaces/tee/ITeePaymentsRegistry.sol) | Payment-stream accounting (outside the diamond). |
