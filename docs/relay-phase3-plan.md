...
| **AC-6 core** threshold-consistency (no unsafe-threshold policy; setter + Mode-1 formula) | `RelayThresholdConsistencyFV` | ✅ verified (Mode-1 message-construction scoped separately) |
