...
> governance redesign. Legacy governance rows are retained as an engagement
...
| **∀N ∀K sig-loop threshold soundness** (theorem prover, abstract algorithm) | `lean/RelaySigLoop.lean` | ✅ verified (Lean 4) |
